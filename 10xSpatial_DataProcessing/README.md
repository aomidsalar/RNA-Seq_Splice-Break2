...
Spatial bam files were converted to fastq files using the 10x Genomics program [`bamtofastq_linux`](https://support.10xgenomics.com/docs/bamtofastq). This resulted in 3 sets of fastq files per sample (see https://davetang.org/muse/2018/06/06/10x-single-cell-bam-files/ for more information):

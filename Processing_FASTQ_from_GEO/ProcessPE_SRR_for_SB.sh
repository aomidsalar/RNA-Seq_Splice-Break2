...
nohup /path/to/SpliceBreak/Splice-Break2_paired-end.sh input_directory/ output_directory/ logs_directory/ SB_Path/ --align=yes --ref=rCRS --fastq_keep=no --skip_preAlign=yes > nohup.out &
